...
public class StringToTuple implements FlatMapFunction<String, Tuple3<String, String, Boolean>> {

    private ObjectMapper objectMapper = new ObjectMapper();
    @Override
    public void flatMap(String json, Collector<Tuple3<String, String, Boolean>> out) throws Exception {
